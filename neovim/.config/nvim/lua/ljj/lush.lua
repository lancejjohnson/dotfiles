...
-- Polar Night
local nord0 = hsl("#2e3440")
local nord1 = hsl("#3b4252")
local nord2 = hsl("#434c5e")
local nord3 = hsl("#4c566a")

-- Snow Storm
local nord4 = hsl("#d8dee9")
local nord5 = hsl("#e5e9f0")
local nord6 = hsl("#eceff4")

-- Frost
local nord7 = hsl("#8fbcbb")
local nord8 = hsl("#88c0d0")
local nord9 = hsl("#81a1c1")
local nord10 = hsl("#5e81ac")

-- Aurora
local nord11 = hsl("#bf616a")
local nord12 = hsl("#d08770")
local nord13 = hsl("#ebcb8b")
local nord14 = hsl("#a3be8c")
local nord15 = hsl("#b48ead")
...
local theme = lush(function()
  return {
    ...
    -- Uncomment "Normal"
    Normal { bg = nord6, fg = nord0 }, -- normal text
    ...
    CursorLine { bg = Normal.bg.darken(5) }, -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if foreground (ctermfg OR guifg) is not set.
    ...
    Comment { fg=nord3, gui="italic" },

    -- Here's how we might set our line numbers to be relational to Normal,
    -- note we'er also using some shorter aliases here.
    -- (`setlocal number`)
    LineNr       { bg = Normal.bg, fg = Normal.fg.li(55) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    CursorLineNr { bg = Normal.bg.darken(5), fg = Normal.fg }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    ...
    Constant       { fg=nord10 }, -- (preferred) any constant
    String         { fg=nord14 }, --   a string constant: "this is a string"
