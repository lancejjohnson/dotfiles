  ...
  (setq-default
   ...
   '(
     ...
     (ruby :variables
        ...
        ;; NOTE: Enhanced mode breaks Ruby syntax highlighting in solarized
...
(defun dotspacemacs/init ()
  ...
  (setq-default
   ...
   ;;   :size-limit-kb 1000)
   ;; (default nil)
   ;; TODO: Add relative for various modes once you've installed all the modes you want
...
you should place your code here."
    ...
    (global-hl-line-mode -1) ;; Turn off highlighting current line
    (golden-ratio-mode t)
